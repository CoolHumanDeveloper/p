<?php echo $header; ?>
	...
	<tr>
	<th width=50px>Title</th><td><input type="text" name="subject" value="<?php echo $p->subject; ?>" style="width:800px"></td>
	</tr>
	<tr>
	<th>Preview Image</th>
	<td>
	...
	foreach($sorted_cats as $c)
	{
		...
		for($j = 0; $j < $c->dep; $j++)
			$space .= "&nbsp;&nbsp;";
		echo "<option value='" . $c->id . "'" . (in_array($c->id, $cats) ? " selected" : "") . ">$space" . $c->name . "</option>";
	}
	?>
	</select>
	</td>
	...
	<td style="background-color:#fff;">
		...
		<textarea id='Form_Body' name="cpublic" rows="10" style="width:100%"><?php echo $p->cpublic; ?></textarea>
	</td>
	</tr>
	<tr>
	<th valign=top>Private Content</th>
	<td style="background-color:#fff;">
		<textarea name="cprivate" rows="10" style="width:99%;resize:none;"><?php echo $p->cprivate; ?></textarea>
	</td>
	</tr>
	<tr>
